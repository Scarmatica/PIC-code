...
MAIN	CALL 	VENT_PAA_STARTBIT 	; Loop her indtil der modtages en puls på 2,4 ms
		...
		MOVFW 	INPUT_BYTE 			; Flyt de 8 bit fra INPUT_BYTE registret til W registret
 		SUBLW	b'10010110'			; Den byte, der skulle sendes trækkes fra W registret
		BTFSS	STATUS,ZEROBIT		; Der tjekkes for ZEROBIT
		GOTO	MAIN
		COMF	OUTPUT_FIL			; OUTPUT_FIL komplementeres, så outputtet skifter hver gang den mtodtager et nyt signal.
